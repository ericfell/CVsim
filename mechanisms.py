...
class EReversibleScheme(CyclicVoltammetryScheme):
    """
...
class EQuasireversibleScheme(CyclicVoltammetryScheme):
    """
...
class EQuasireversibleWithHomogeneousKineticsScheme(CyclicVoltammetryScheme):
    """
...
class EEScheme(CyclicVoltammetryScheme):
    """
